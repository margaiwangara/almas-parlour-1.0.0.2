                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="product-box">
                                                ...
                                                <a href="view/display-item.php?ic=<?php echo md5($featured_id[$key]);?>-<?php echo $featured_id[$key];?>" class="thumbnail">
                                                    <img src="<?php echo $featured_image[$key];?>" alt="product-image-<?php echo md5($featured_id[$key]);?>" />
                                                </a>
                                                <a href="view/display-item.php?ic=<?php echo md5($featured_id[$key]);?>-<?php echo $featured_id[$key];?>" class="title">
                                                    <?php echo $featured_name[$key];?>
                                                </a><br/>
                                                <a href="view/display-item.php?ic=<?php echo md5($featured_id[$key]);?>-<?php echo $featured_id[$key];?>" class="category">
